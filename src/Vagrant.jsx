...
const Engine = () => {
	...
	return (
		<group position={[3.2, 1, -1.95]} scale={[4, 3, 3]}>
			<pointLight
				// castShadow
		...
		<>
			<group {...props} dispose={null}>
				...
				<group
					...
					onClick={(e) => {
						e.stopPropagation();
						setStateContext({ movingTowards: new Vector3(10, 20, 10) });
					}}
				>
				...
				<mesh
					onClick={(e) => {
						e.stopPropagation();
						setStateContext({ movingTowards: new Vector3(20, 20, 10) });
					}}
					castShadow
					receiveShadow
					geometry={nodes.Cube.geometry}
					material={materials.rust}
					position={[0.19, -1.63, -1.34]}
					rotation={[0, 0.12, 0]}
					scale={[4.83, 0.15, 1]}
				/>
				<mesh
				...
				<mesh
					...
					material={materials["upper hood"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Plane_2.geometry}
					material={materials["lower hood"]}
				/>
			</group>
		</>
	);
